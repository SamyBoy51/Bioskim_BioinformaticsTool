Hi! this is a project made for bioinformatics, it isnt a suepr-powerful tool, and it only reads FASTA files in the meantime. Im looking forward to expanding it and keep making it more 'pretty'
This is also my first time using Github, so i dont even know how to organize the project, nor how versions work. As far as im concerned i'll update the version to 0.1 when i jsut do small debugging 
